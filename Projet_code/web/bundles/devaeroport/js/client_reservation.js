...
$(function () {
    ...
    $(".deleteLink").click(function () {
        ...
        // Récupération de l'id de l'reservation : row-NUMERO -> suppression de 'row-'
        var idVol = oTR.attr("id").substring(4);
        // Récupération du titre
        var titre = oTR.find("#volNom").html();
        
        if (idVol != '' && confirm("Voulez-vous supprimer la reservation pour '" + titre + "' ? "))
        {
